...
public class MemberProfileController {
    ...
    public ResponseEntity<ResponseDto> confirmPassword(Authentication auth,
        @Valid @RequestBody String inputPassword) {
    ...
    public ResponseEntity<ResponseDto> modifyProfile(
        @Valid @RequestBody MemberProfileRequestDto memberProfileRequestDto) {
