...
public class BookmarkServiceImpl implements BookmarkService {
    ...
    public ResponseDto createBookmark(BookmarkRequestDto bookmarkRequest, Authentication auth) {
        ...
        Performance performance = performanceRepository.findByIdAndName(bookmarkRequest.getPerformance(), bookmarkRequest.getPerformanceName()).orElseThrow(()-> new MisinformationException());

        PerformanceSchedule performanceSchedule = performanceScheduleRepository.findByPerformanceId(performance).orElseThrow(()-> new MisinformationException());
